...
def create_prior(prior_type, **kwargs):
    """Factory for pose prior implementations."""
    if prior_type == "gmm":
...
class SMPLifyAnglePrior(nn.Module):
    """Angle prior module used by SMPLify."""
...
class MaxMixturePrior(nn.Module):
    """Gaussian-mixture pose prior used in optimization losses."""
    ...
    def get_mean(self):
        ...
        return torch.matmul(self.weights, self.means)  # mean_pose
